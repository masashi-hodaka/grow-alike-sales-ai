...
const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    bgColor: '#eff6ff',
    skills: [
      { id: 's1', name: 'リスト作成', category: 'prospecting', mastery: 'mastered', score: 88, xpRequired: 200, xpCurrent: 200, isWeak: false,
        description: 'ターゲットリストの質と量を高めるスキル',
        tips: ['業種×役職でセグメント', 'LinkedInを活用', 'ICP（理想顧客プロファイル）を定義'] },
      { id: 's2', name: 'ターゲティング', category: 'prospecting', mastery: 'practiced', score: 72, xpRequired: 300, xpCurrent: 216, isWeak: false,
        description: 'アプローチすべき企業・担当者の優先順位付け',
        tips: ['BANTで絞り込む', '購買シグナルを探す', '決裁者にアプローチ'] },
      { id: 's3', name: 'SNS活用', category: 'prospecting', mastery: 'learning', score: 45, xpRequired: 200, xpCurrent: 90, isWeak: true,
  ...
  },
  {
    ...
    bgColor: '#f5f3ff',
    skills: [
      { id: 's4', name: '電話オープニング', category: 'opening', mastery: 'practiced', score: 78, xpRequired: 200, xpCurrent: 156, isWeak: false,
        description: '最初の15秒で相手の興味を引くスキル',
        tips: ['用件を先に言う', 'メリット起点で話す', 'ゲートキーパー突破術'] },
      { id: 's5', name: 'アイスブレイク', category: 'opening', mastery: 'mastered', score: 91, xpRequired: 150, xpCurrent: 150, isWeak: false,
        description: '自然な雑談から本題へ移行するスキル',
        tips: ['共通点を見つける', '業界ニュースを活用', '相手を主役にする'] },
      { id: 's6', name: '自己紹介', category: 'opening', mastery: 'practiced', score: 69, xpRequired: 150, xpCurrent: 104, isWeak: false,
  ...
  },
  {
    ...
    bgColor: '#f0fdf4',
    skills: [
      { id: 's7', name: '課題ヒアリング', category: 'hearing', mastery: 'learning', score: 52, xpRequired: 400, xpCurrent: 208, isWeak: true,
        description: '潜在課題まで掘り下げる質問スキル',
        tips: ['「なぜ？」を3回繰り返す', 'SPIN質問法を使う', '沈黙を恐れない'] },
      { id: 's8', name: '決裁フロー把握', category: 'hearing', mastery: 'learning', score: 61, xpRequired: 300, xpCurrent: 183, isWeak: true,
        description: '誰が何を決める組織なのかを把握するスキル',
        tips: ['MEDDIC/BANT確認', '意思決定者を巻き込む', '稟議プロセスを聞く'] },
      { id: 's9', name: 'ニーズ整理', category: 'hearing', mastery: 'practiced', score: 70, xpRequired: 250, xpCurrent: 175, isWeak: false,
  ...
  },
  {
    ...
    bgColor: '#fffbeb',
    skills: [
      { id: 's10', name: 'ソリューション提案', category: 'proposition', mastery: 'practiced', score: 74, xpRequired: 400, xpCurrent: 296, isWeak: false,
        description: '課題に直結した提案を作るスキル',
        tips: ['課題→解決策の流れを守る', 'ROIを明示する', '具体的な数字で語る'] },
      { id: 's11', name: '資料作成', category: 'proposition', mastery: 'mastered', score: 85, xpRequired: 300, xpCurrent: 300, isWeak: false,
        description: '説得力のある提案資料を作るスキル',
        tips: ['1スライド1メッセージ', '顧客名を入れる', 'ストーリーで構成する'] },
      { id: 's12', name: '競合差別化', category: 'proposition', mastery: 'learning', score: 58, xpRequired: 350, xpCurrent: 203, isWeak: true,
  ...
  },
  {
    ...
    bgColor: '#fef2f2',
    skills: [
      { id: 's13', name: '価格反論', category: 'objection', mastery: 'learning', score: 55, xpRequired: 350, xpCurrent: 193, isWeak: true,
        description: '「高い」「予算がない」という反論への対処',
        tips: ['ROIで語る', '初期費用と総費用を分けて説明', '分割払い等の代替案を提示'] },
      { id: 's14', name: '時期反論', category: 'objection', mastery: 'practiced', score: 67, xpRequired: 300, xpCurrent: 201, isWeak: true,
  ...
  },
  {
    ...
    bgColor: '#fff7ed',
    skills: [
      { id: 's16', name: 'クローズ手法', category: 'closing', mastery: 'learning', score: 63, xpRequired: 400, xpCurrent: 252, isWeak: false,
        description: '成約率を高めるクロージングテクニック',
        tips: ['想定反論を事前に潰す', 'チョイスクローズを活用', '次のステップを具体的に合意'] },
      { id: 's17', name: '稟議サポート', category: 'closing', mastery: 'learning', score: 48, xpRequired: 300, xpCurrent: 144, isWeak: true,
